...
describe('git', function () {
  ...
  it('translates exec Errno::ENOENT to a friendlier error message', function () {
    ...
    return expect(git.exec(['remote']), 'to be rejected with', 'Git must be installed to use the Heroku Toolbelt.  See instructions here: http://git-scm.com')
  })
  ...
  it('translates spawn Errno::ENOENT to a friendlier error message', function () {
    ...
    return expect(git.spawn(['remote']), 'to be rejected with', 'Git must be installed to use the Heroku Toolbelt.  See instructions here: http://git-scm.com')
  })
